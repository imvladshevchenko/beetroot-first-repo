...
// 5
const distance = prompt("Чему равно расстояние от вашей локации до места назначения?");
...
// 7
const usbSize = prompt("Укажите объем флешки в ГБ, чтобы узнать сколько файлов обьемом 820 мб на неё поместится");
